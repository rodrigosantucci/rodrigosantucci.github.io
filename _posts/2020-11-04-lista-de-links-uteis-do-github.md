...
## 🗂 Repositórios úteis
* [Public APIs](https://github.com/public-apis/public-apis) - Listagem de APIs Públicas
* [Make Your Own X](https://github.com/danistefanovic/build-your-own-x) - Faça seu próprio X
* [The System Design Primer](https://github.com/donnemartin/system-design-primer) - Cartilha completa para Engenharia de Software 
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) - A arte da linha de comando
* [JavaScript Algorithms and Data Structures](https://github.com/trekhleb/javascript-algorithms) - Exemplos de Algoritmos e Estrutura de dados em JavaScript
* [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - Boas práticas com NodeJS
* [App Ideas Collection](https://github.com/florinpop17/app-ideas) - Coleção de ideas de criação de app's por nível
* [Developer-Roadmap](https://github.com/kamranahmedse/developer-roadmap) - Roadmap para o Desenvolvedor Web
* [Recursos Gratuitos](https://github.com/iuricode/recursos-gratuitos) - Lista de recursos Front-end gratuitos
* [Clones de interfaces](https://github.com/iuricode/clones-interfaces) - Clones de interfaces conhecidas como, Netflix, Instagram etc.
